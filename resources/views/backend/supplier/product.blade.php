                        ...
                        <div class="card-body p-0">
                            <div class="tab-content">
                                <div class="tab-pane active " id="tab1">
                                    <form class="form-horizontal p-5" method="post" action="{{ url('admin/suppliers/product/update') }}" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="p[supplier_id]" value="{{ $supplier->id }}">
