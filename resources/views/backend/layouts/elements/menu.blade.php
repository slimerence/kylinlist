...
<aside class="app-sidebar doc-sidebar">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-institution"></i><span class="side-menu__label">Category Management</span><i class="angle fa fa-angle-right"></i></a>
            <ul class="slide-menu">
