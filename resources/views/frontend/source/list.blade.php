                            ...
                            <div class="item-card2">
                                <div class="item-card2-desc">
                                    ...
                                    <div class="item-card2-text">
                                        <a href="classified.html" class="text-dark"><h4 class="">Somik Restaurant</h4></a>
                                    </div>
                ...
                <div class="item">
                    <div class="card mb-0">
                        ...
                        <div class="card-body">
                            <div class="item-card2">
                                <div class="item-card2-desc">
                                    ...
                                    <div class="item-card2-text">
                                        <a href="classified.html" class="text-dark"><h4 class="">GilkonStar Hotel</h4></a>
                                    </div>
                                    <p class="">Ut enim ad minima veniam, quis int nostrum exercitationem </p>
                                    <div class="item-card2-rating mb-0">
                                        <div class="rating-stars d-inline-flex">
                        ...
                        <div class="card-footer">
                            <div class="item-card2-footer ">
                                <div class="item-card2-footer-u">
                                    <div class="icons text-dark"><i class="si si-user text-muted mr-1"></i>Sally <a href="#" class="ml-1" data-toggle="tooltip" data-placement="bottom" title="Verified"><i class="si si-check text-success fs-12"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="card mb-0">
                        ...
                        <div class="card-body">
                            <div class="item-card2">
                                <div class="item-card2-desc">
                                    ...
                                    <div class="item-card2-text">
                                        <a href="classified.html" class="text-dark"><h4 class="">Sear Beauty & Spa</h4></a>
                                    </div>
                                    <p class="">Ut enim ad minima veniam, quis int nostrum exercitationem </p>
                                    <div class="item-card2-rating mb-0">
                                        <div class="rating-stars d-inline-flex">
                        ...
                        <div class="card-footer">
                            <div class="item-card2-footer">
                                <div class="item-card2-footer-u">
                                    <div class="icons text-dark"><i class="si si-user text-muted mr-1"></i>Keith <a href="#" class="ml-1" data-toggle="tooltip" data-placement="bottom" title="Verified"><i class="si si-check text-success fs-12"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="card mb-0">
                        ...
                        <div class="card-body">
                            <div class="item-card2">
                                <div class="item-card2-desc">
                                    ...
                                    <div class="item-card2-text">
                                        <a href="classified.html" class="text-dark"><h4 class="">Seep Automobiles</h4></a>
                                    </div>
                                    <p class="">Ut enim ad minima veniam, quis int nostrum exercitationem </p>
                                    <div class="item-card2-rating mb-0">
                                        <div class="rating-stars d-inline-flex">
                        ...
                        <div class="card-footer">
                            <div class="item-card2-footer">
                                <div class="item-card2-footer-u">
                                    <div class="icons text-dark"><i class="si si-user text-muted mr-1"></i>Baker <a href="#" class="ml-1" data-toggle="tooltip" data-placement="bottom" title="Verified"><i class="si si-check text-success fs-12"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="card mb-0">
                        ...
                        <div class="card-footer">
                            <div class="item-card2-footer">
                                <div class="item-card2-footer-u">
                                    <div class="icons text-dark"><i class="si si-user text-muted mr-1"></i>Steven <a href="#" class="ml-1" data-toggle="tooltip" data-placement="bottom" title="Verified"><i class="si si-check text-success fs-12"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="card mb-0">
                        ...
                        <div class="card-footer">
                            <div class="item-card2-footer">
                                <div class="item-card2-footer-u">
                                    <div class="icons text-dark"><i class="si si-user text-muted mr-1"></i>Lauren<a href="#" class="ml-1" data-toggle="tooltip" data-placement="bottom" title="Verified"><i class="si si-check text-success fs-12"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="card mb-0">
                        ...
                        <div class="card-footer">
                            <div class="item-card2-footer">
                                <div class="item-card2-footer-u">
                                    <div class="icons text-dark"><i class="si si-user text-muted mr-1"></i>Mathis <a href="#" class="ml-1" data-toggle="tooltip" data-placement="bottom" title="Verified"><i class="si si-check text-success fs-12"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="card mb-0">
                        ...
                        <div class="card-body">
                            <div class="item-card2">
                                <div class="item-card2-desc">
                                    ...
                                    <div class="item-card2-text">
                                        <a href="classified.html" class="text-dark"><h4 class="">Bure Spa</h4></a>
                                    </div>
                                    <p class="">Ut enim ad minima veniam, quis int nostrum exercitationem </p>
                                    <div class="item-card2-rating mb-0">
                                        <div class="rating-stars d-inline-flex">
                        ...
                        <div class="card-footer">
                            <div class="item-card2-footer">
                                <div class="item-card2-footer-u">
                                    <div class="icons text-dark"><i class="si si-user text-muted mr-1"></i> Liam <a href="#" class="ml-1" data-toggle="tooltip" data-placement="bottom" title="Verified"><i class="si si-check text-success fs-12"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
