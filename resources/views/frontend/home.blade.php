        ...
        <div class="header-text mb-0">
            <div class="container">
                <div class="text-center text-white ">
                    <h1 class="">Biggest Business Directory in the World</h1>
                        ...
                        <div class=" search-background">
                            <div class="form row no-gutters">
                                <div class="form-group  col-xl-6 col-lg-5 col-md-12 mb-0">
                                    <input type="text" class="form-control input-lg border-right-0" id="text" placeholder="Search here">
                                </div>
...
<section class="sptb">
    <div class="container">
        ...
        <div id="feature-carousel" class="owl-carousel owl-carousel-icons">
            ...
            <div class="item">
                <div class="card mb-0">
                    <div class="arrow-ribbon bg-primary">Closed</div>
                    <div class="item-card7-imgs">
                        <a href="business.html"></a>
                        <img src="../assets/images/products/products/h3.jpg" alt="img" class="cover-image">
                    </div>
                    <div class="item-card7-overlaytext">
                        <a href="business.html" class="text-white"> Hotel</a>
                    </div>
                    <div class="card-body">
                        <div class="item-card7-desc">
                            <div class="item-card7-text">
                                <a href="business.html" class="text-dark"><h4 class="font-weight-semibold">2Bk Delux Flat</h4></a>
                            </div>
                            <ul class="d-flex">
                                <li class=""><a href="#" class="icons"><i class="si si-location-pin text-muted mr-1"></i> USA</a></li>
                                <li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 10 min ago</a></li>
                                <li class=""><a href="#" class="icons"><i class="si si-phone text-muted mr-1"></i> 14 675 65430</a></li>
                            </ul>
                            <p class="mb-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque.</p>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="footerimg d-md-flex mt-0 mb-0">
                            <div class="d-flex footerimg-l mb-0">
                                <img src="../assets/images/faces/male/12.jpg" alt="image" class="avatar brround  mr-2">
                                <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">Boris	Nash <i class="si si-check text-success fs-12 ml-1" data-toggle="tooltip" data-placement="top" title="verified"></i></h5>
                            </div>
                            <div class="mt-2 footerimg-r ml-auto">
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Comments"><span class="text-muted mr-2"><i class="fa fa-comment-o"></i> 16</span></a>
            ...
            <div class="item">
                <div class="card mb-0">
                    ...
                    <div class="card-body">
                        <div class="item-card7-desc">
                            <div class="item-card7-text">
                                <a href="business.html" class="text-dark"><h4 class="font-weight-semibold">5 Star Hotel </h4></a>
                            </div>
                            <ul class="d-flex">
                                <li class=""><a href="#" class="icons"><i class="si si-location-pin text-muted mr-1"></i> USA</a></li>
                                <li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 1 hour ago</a></li>
                                <li class=""><a href="#" class="icons"><i class="si si-phone text-muted mr-1"></i> 14 675 65430</a></li>
                            </ul>
                            <p class="mb-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque.</p>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="footerimg d-md-flex mt-0 mb-0">
                            <div class="d-flex footerimg-l mb-0">
                                ...
                                <h5 class="time-title text-muted p-0 leading-normal mt-2">Wendy	Peake<i class="si si-check text-success fs-12 ml-1" data-toggle="tooltip" data-placement="top" title="verified"></i></h5>
                            </div>
                            <div class="mt-2 footerimg-r ml-auto">
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Comments"><span class="text-muted mr-2"><i class="fa fa-comment-o"></i> 8</span></a>
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Views"><span class="text-muted"><i class="fa fa-eye"></i> 12</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="item-card7-desc">
                            <div class="item-card7-text  d-flex">
                                <a href="business.html" class="text-dark"><h4 class="font-weight-semibold">2Bk DeluxRooms</h4></a>
                            </div>
                            <ul class="d-flex">
                                <li class=""><a href="#" class="icons"><i class="si si-location-pin text-muted mr-1"></i> USA</a></li>
                    ...
                    <div class="card-footer">
                        <div class="footerimg d-md-flex mt-0 mb-0">
                            <div class="d-flex footerimg-l mb-0">
                                ...
                                <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">Joshua Dickens<i class="si si-check text-success fs-12 ml-1" data-toggle="tooltip" data-placement="top" title="verified"></i></h5>
                            </div>
                            <div class="mt-2 footerimg-r ml-auto">
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Comments"><span class="text-muted mr-2"><i class="fa fa-comment-o"></i> 16</span></a>
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Views"><span class="text-muted"><i class="fa fa-eye"></i> 22</span></a>
            ...
            <div class="item">
                <div class="card mb-0">
                    <div class="arrow-ribbon bg-warning">30% Off</div>
                    <div class="item-card7-imgs">
                        <a href="business.html"></a>
                    ...
                    <div class="card-body">
                        <div class="item-card7-desc">
                            <div class="item-card7-text">
                                <a href="business.html" class="text-dark"><h4 class="font-weight-semibold">Chinese Restaurant</h4></a>
                            </div>
                            <ul class="d-flex">
                                <li class=""><a href="#" class="icons"><i class="si si-location-pin text-muted mr-1"></i> USA</a></li>
                                <li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 5 hours ago</a></li>
                    ...
                    <div class="card-footer">
                        <div class="footerimg d-md-flex mt-0 mb-0">
                            <div class="d-flex footerimg-l mb-0">
                                ...
                                <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">Ryan Lyman<i class="si si-check text-success fs-12 ml-1" data-toggle="tooltip" data-placement="top" title="verified"></i></h5>
                            </div>
                            <div class="mt-2 footerimg-r ml-auto">
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Comments"><span class="text-muted mr-2"><i class="fa fa-comment-o"></i> 6</span></a>
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Views"><span class="text-muted"><i class="fa fa-eye"></i> 25</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="card mb-0">
                    ...
                    <div class="card-body">
                        <div class="item-card7-desc">
                            <div class="item-card7-text">
                                <a href="business.html" class="text-dark"><h4 class="font-weight-semibold">Multi Model Restaurant</h4></a>
                            </div>
                            <ul class="d-flex">
                                <li class=""><a href="#" class="icons"><i class="si si-location-pin text-muted mr-1"></i> USA</a></li>
                                <li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 5 hours ago</a></li>
                    ...
                    <div class="card-footer">
                        <div class="footerimg d-md-flex mt-0 mb-0">
                            <div class="d-flex footerimg-l mb-0">
                                ...
                                <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">Joan Hunter<i class="si si-check text-success fs-12 ml-1" data-toggle="tooltip" data-placement="top" title="verified"></i></h5>
                            </div>
                            <div class="mt-2 footerimg-r ml-auto">
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Comments"><span class="text-muted mr-2"><i class="fa fa-comment-o"></i> 19</span></a>
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Views"><span class="text-muted"><i class="fa fa-eye"></i> 24</span></a>
                            </div>
                        </div>
                    </div>
                </div>
